...
[![Codecov test coverage](https://codecov.io/gh/jackedtaylor/lexops/graph/badge.svg)](https://app.codecov.io/gh/jackedtaylor/lexops)
<!-- badges: end -->

LexOPS is an R package for generating matched stimuli for factorial design experiments. You can use the functions on any dataframe, but there is a database of example features for English words for psycholinguistics studies in English (`LexOPS::lexops`).
