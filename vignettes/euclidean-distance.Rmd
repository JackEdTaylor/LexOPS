...
Euclidean distance is the straight-line distance between two points in $n$-dimensional space. Between points $a$ and $b$, the Euclidean distance $d(a,b)$ is:
...
To help visualise this, Euclidean distance in 2-dimensional space is just Pythagoras' theorem:
