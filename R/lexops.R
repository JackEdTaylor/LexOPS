...
#'  \item{BG.SUBTLEX_UK}{Mean bigram probabilities for each string, calculated using frequency data from UK subtitles (\url{https://doi.org/10.1080/17470218.2013.850521}).}
#'  \item{BG.SUBTLEX_US}{Mean bigram probabilities for each string, calculated using frequency data from US subtitles (\url{https://doi.org/10.3758/BRM.41.4.977}).}
#'  \item{BG.BNC.Spoken}{Mean bigram probabilities for each string, calculated using frequency data calculated for the \emph{spoken} texts of the British National Corpus (\url{http://www.natcorp.ox.ac.uk/}).}
#'  \item{BG.BNC.Written}{Mean bigram probabilities for each string, calculated using frequency data calculated for the \emph{written} texts of the British National Corpus (\url{http://www.natcorp.ox.ac.uk/}).}
